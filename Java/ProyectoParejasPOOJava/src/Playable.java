...
public class Playable extends Character {
    ...
    public Playable(String name, int maxHp, int atk, int spd,
        ...
        levelTable.add(new LevelEntry(5, 180, new Heal(),                  3, 1, 1, 1, 4));
        levelTable.add(new LevelEntry(6, 300, null,            6, 3, 1, 2, 2));
        levelTable.add(new LevelEntry(7, 650, null,                  10, 5, 1, 4, 3));
        levelTable.add(new LevelEntry(8, 1400,new FireBall(),        20, 6, 2, 4, 5));
    }
